...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Getting started with RecDesk","Welcome"],
	DREX_NODE_LINKS: ["getting_started_with_recdesk.htm","welcome.htm"],
...
DR_EXPLAIN.data_search = {
	...
	DREXPLAIN_ERROR_LOCAL_SEARCH_IN_CHROME : "Google Chrome doesn\'t support search in local HTML files. Upload your files to webserver or use another browser."
